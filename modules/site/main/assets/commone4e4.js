(function() {
    ...
    new Vue({
        ...
        el: '#App',
        data: {
            tokens: [{symbol: 'eft', address: null, decimals: 8, balance: 0, round: 6}],
            route_address: '',
            visible: {
                tab: 'swap',
                modal: '',
        ...
        mounted() {
            ...
            if(m) {
                ...
                if(m[2] && this.tokenBySymbol(m[2]).symbol) this.swap.from = m[1];
                if(m[3] && this.tokenBySymbol(m[3]).symbol) this.swap.to = m[2];
            }
